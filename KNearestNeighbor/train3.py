...
def main():
    ...
    X_train_small, X_test_small = preprocess_data(X_train_small, X_test_small)
    ...
    print("y_test first 10 true labels:", y_test_small[:10])
    
    accuracy = np.sum(y_pred == y_test_small) / y_test_small.shape[0]
    print(f'Accuracy on small subset: {accuracy * 100:.2f}%')
